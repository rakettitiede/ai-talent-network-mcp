...
| `PARTNER` | Partner company name in camelCase (e.g. `rakettitiede`, `fraktio`). Used to prefix OpenAPI operationIds for Minna CustomGPT compatibility. Defaults to `unknown` if not set. |
